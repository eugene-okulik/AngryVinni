...
study_books = [
    ...
    SchoolBooks("Физика", "DR.Dre", 157, "978-5-389-07487-1", "физика", "9",
                reserved_book=True),
    SchoolBooks("История", "Держинский", 237, "978-5-389-07487-1",
                "история", "6"),
    SchoolBooks("Биология", "Васелькова", 47, "978-5-389-07487-1",
                "биология", "9"),
    SchoolBooks("Философия", "Кант", 1277, "978-5-389-07487-1",
                "философия", "9"),
